        ...
        <div class="modal-dialog modal-dialog-centered modal-full" role="document">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Jawaban</label>
                    <textarea rows="12" type="text" class="form-control e_body" name="a_body"></textarea>
                </div>
            </div>
            <div class="modal-footer">
                <input type="hidden" name="a_id" class="e_id">
                <input type="hidden" name="q_id" class="e_q_id">
                <input type="hidden" name="a_user_id" class="e_user_id">
